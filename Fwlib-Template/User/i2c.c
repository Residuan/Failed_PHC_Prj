...
u8 WriteI2C_Byte(u8 addr, u8 data)//写一个数据
{
	...
	{
		//printf("Wait!1\n");
		if((I2CTimeout--) == 0) return printf("I2C Timeout error!1\n");
	}
  I2CTimeout = I2CT_FLAG_TIMEOUT;
	...
	{
		//printf("Wait!2\n");
		if((I2CTimeout--) == 0) return printf("I2C Timeout error!2\n");
	}
  I2CTimeout = I2CT_FLAG_TIMEOUT;

	I2C_Send7bitAddress(I2C1, MPU6050ID, I2C_Direction_Transmitter);
	while(!I2C_CheckEvent(I2C1, I2C_EVENT_MASTER_TRANSMITTER_MODE_SELECTED))
	{
		//printf("Wait!3\n");
		if((I2CTimeout--) == 0) return printf("I2C Timeout error!3\n");
	}
  I2CTimeout = I2CT_FLAG_TIMEOUT;
	...
	{
		//printf("Wait!4\n");
		if((I2CTimeout--) == 0) return printf("I2C Timeout error!4\n");
	}
  I2CTimeout = I2CT_FLAG_TIMEOUT;
	...
	{
		//printf("Wait!5\n");
		if((I2CTimeout--) == 0) return printf("I2C Timeout error!5\n");
	}
  I2CTimeout = I2CT_FLAG_TIMEOUT;
...
u8 WriteI2C_Len(u8 addr,u8 reg, u8 len, u8 *buf)//写一串数据
{
	u8 i;
	I2CTimeout = I2CT_FLAG_TIMEOUT;
	...
	{
		//printf("Wait!1\n");
		if((I2CTimeout--) == 0) return printf("I2C Timeout error!6\n");
	}
  I2CTimeout = I2CT_FLAG_TIMEOUT;
	...
	{
		//printf("Wait!2\n");
		if((I2CTimeout--) == 0) return printf("I2C Timeout error7!\n");
	}
  I2CTimeout = I2CT_FLAG_TIMEOUT;
	...
	{
		//printf("Wait!3\n");
		if((I2CTimeout--) == 0) return printf("I2C Timeout error!8\n");
	}
  I2CTimeout = I2CT_FLAG_TIMEOUT;
	...
	{
		//printf("Wait!4\n");
		if((I2CTimeout--) == 0) return printf("I2C Timeout error!9\n");
	}
  I2CTimeout = I2CT_FLAG_TIMEOUT;
	for(i=0;i<len;i++)
	{
		...
		{
			//printf("Wait!5\n");
			if((I2CTimeout--) == 0) return printf("I2C Timeout error10!\n");
		}
		I2CTimeout = I2CT_FLAG_TIMEOUT;
...
uint8_t Read_Byte(u8* pBuffer, u8 raddr, u16 Num)//读取一串字节
{
	I2CTimeout = I2CT_FLAG_TIMEOUT;
	while(I2C_GetFlagStatus(I2C1, I2C_FLAG_BUSY))
	{
		//printf("ReadWait!1\n");
		if((I2CTimeout--) == 0) return printf("I2C Timeout error!11\n");
	}
  I2CTimeout = I2CT_FLAG_TIMEOUT;
	I2C_GenerateSTART(I2C1, ENABLE);
	while(!I2C_CheckEvent(I2C1, I2C_EVENT_MASTER_MODE_SELECT))
	{
		//printf("ReadWait!2\n");
		if((I2CTimeout--) == 0) return printf("I2C Timeout error!12\n");
	}
  I2CTimeout = I2CT_FLAG_TIMEOUT;
	...
	{
		//printf("ReadWait!3\n");
    if((I2CTimeout--) == 0) return printf("I2C Timeout error!13\n");
   }
	I2C_Cmd(I2C1, ENABLE);
  I2C_SendData(I2C1, raddr);  
	...
	{
		//printf("ReadWait!4\n");
		if((I2CTimeout--) == 0) return printf("I2C Timeout error!14\n");
	}
  I2CTimeout = I2CT_FLAG_TIMEOUT;
	I2C_GenerateSTART(I2C1, ENABLE);
	while(!I2C_CheckEvent(I2C1, I2C_EVENT_MASTER_MODE_SELECT))
	{
		//printf("ReadWait!5\n");
		if((I2CTimeout--) == 0) return printf("I2C Timeout error!15\n");
	}
  I2CTimeout = I2CT_FLAG_TIMEOUT;
	I2C_Send7bitAddress(I2C1, MPU6050ID, I2C_Direction_Receiver);
	while(!I2C_CheckEvent(I2C1, I2C_EVENT_MASTER_RECEIVER_MODE_SELECTED))
	{
		//printf("ReadWait!6\n");
		if((I2CTimeout--) == 0) return printf("I2C Timeout error!16\n");
	}
  I2CTimeout = I2CT_FLAG_TIMEOUT;
	while(Num)
	{
...
////	{
////		//printf("ReadWait!1\n");
////		if((I2CTimeout--) == 0) return printf("I2C Timeout error!\n");
////	}
////  I2CTimeout = I2CT_FLAG_TIMEOUT;
////	I2C_GenerateSTART(I2C1, ENABLE);
////	while(!I2C_CheckEvent(I2C1, I2C_EVENT_MASTER_MODE_SELECT))
...
////	  while(!I2C_CheckEvent(I2C1, I2C_EVENT_MASTER_MODE_SELECT))
////		{
////	    if((I2CTimeout--) == 0) return printf("I2C Timeout error!7\n");
////	   }
...
////	  while(!I2C_CheckEvent(I2C1, I2C_EVENT_MASTER_MODE_SELECT))
////		{
////	    if((I2CTimeout--) == 0) return printf("I2C Timeout error!10\n");
////	   }
...
////						return printf("I2C Timeout error!12\n");
////				}
////			 }
////			
////	    {
...
/////*static  uint8_t I2C_TIMEOUT_and_Print(void)
////{
